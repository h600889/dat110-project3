...
public int distributeReplicastoPeers() throws RemoteException {
    	...
    	for (BigInteger r : replicafiles) {
    		...
    		NodeInterface successor = chordnode.findSuccessor(r);
        	...
        	successor.saveFileContent(filename, r, bytesOfFile, isPrimary);
        	// increment counter
        	counter++;
    	}
		return counter;
	...
	public Set<Message> requestActiveNodesForFile(String filename) throws RemoteException {
		...
		for (BigInteger r : replicafiles) {
			...
			activeNodesforFile.add(successor.getFilesMetadata().get(r));
		}
